...
public class ProgramFactoryImpl implements ProgramFactory {
	 ...
	 */
	public Interface createInterface(String name, LinkedList<Interface> interfaces, LinkedList<String> unknownInterfaces) {
	    return new InterfaceImpl(name, interfaces, unknownInterfaces);
	}
	 ...
	 */
	public Classe createClasseHeritant(String name, Classe superClasse, String unknownClasse) {
	    return new ClasseHeritantImpl(name, superClasse, unknownClasse);
	}
	 ...
	 * @return Abstract Syntax Tree node for the ClasseHeritant type.
	 */
	public Classe createClasseHeritant(String name, Classe superClasse, LinkedList<Interface> interfaces, String unknownClasse) {
	    return new ClasseHeritantImpl(name, superClasse, interfaces, unknownClasse);
	}
