...
public class RecordTypeImpl implements RecordType, Scope<FieldDeclaration> {
	...
	public boolean equalsTo(Type _other) {
		if (_other instanceof RecordTypeImpl) {
			...
			List<FieldDeclaration> fields1 = getFields();
			List<FieldDeclaration> fields2 = ((RecordTypeImpl) _other).getFields();
			

			return fields1.containsAll(fields2) && fields2.containsAll(fields1);
	...
	public boolean compatibleWith(Type _other) {
		if (_other instanceof RecordTypeImpl) {
			...
			return fields1.containsAll(fields2);
		}
	...
	public Type merge(Type _other) {
		...
		if (_other instanceof RecordTypeImpl) {
			RecordTypeImpl _otherRec = (RecordTypeImpl) _other;
			
			if (_otherRec.compatibleWith(this))
				return _otherRec;
			else if (this.compatibleWith(_otherRec))
				return this;
		}
