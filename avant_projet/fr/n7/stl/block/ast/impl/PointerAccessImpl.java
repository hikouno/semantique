...
public class PointerAccessImpl implements Expression {
	...
	@Override
	public Type getType() {
		return ((PointerTypeImpl) pointer.getType()).getPointedType();
	}
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		if (pointer instanceof VariableUseImpl) {
			VariableDeclaration declaration = ((VariableUseImpl) pointer).getDeclaration();
			res.add(_factory.createLoad(declaration.getRegister(),
