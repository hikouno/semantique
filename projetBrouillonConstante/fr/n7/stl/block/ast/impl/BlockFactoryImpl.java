...
public class BlockFactoryImpl implements BlockFactory {
	 ...
	 */
	@Override
	public ConstantDeclaration createConstantDeclaration(String _name, Type _type, Expression _value, Interface _interf) {
		return new ConstantDeclarationImpl(_name,_type,_value, _interf);
	}
